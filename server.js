...
var message =
  "Thanks for visiting the app!  Our next hackathon is scheduled for the end of Q3.  We hope to see you there, be sure to add your ideas to the app!";
...
app.get("/ideas", (req, res) => {
  // let count = req.query.count !== undefined ? req.query.count : 100;
  // if (req.query.owner) {
  //   let ownerIdeas = ideas.filter((idea) => idea.owner == req.query.owner);
